...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controls = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyActions = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteConstants = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Key = __webpack_require__(169);
	var NoteConstants = __webpack_require__(167);
	var Recorder = __webpack_require__(189);
	var Songs = __webpack_require__(191);
	...
	var Organ = React.createClass({
	  ...
	  render: function () {
	    ...
	    var keys = Object.keys(NoteConstants).map(function (note) {
	      i++;
	      return React.createElement(Key, { key: i, noteName: note, wave: wave });
	    });
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'author' },
	        'Created by Jessica Yao (',
	        React.createElement(
	          'a',
	          { href: 'https://github.com/jyao9/Beginner-Piano' },
	          'GitHub'
	        ),
	        ' ● ',
	        React.createElement(
	          'a',
	          { href: 'https://www.linkedin.com/in/jessyao9' },
	          'LinkedIn'
	        ),
	        ' ● ',
	        React.createElement(
	          'a',
	          { href: 'http://www.jessicayao.com' },
	          'Website'
	        ),
	        ')'
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxMapStore = (function (_FluxReduceStore) {
	  ...
	  FluxMapStore.prototype.at = function at(key) {
	    !this.has(key) ?  false ? invariant(false, 'Expected store to have key %s', key) : invariant(false) : undefined;
	    return this.get(key);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Notes = __webpack_require__(192);
	...
	var Songs = React.createClass({
	  ...
	  render: function () {
	    var songList = ["Mary Had a Little Lamb", "Twinkle, Twinkle Little Star", "Do Re Mi", "Ode to Joy", "Minuet"];
	    var count = 0;
	    var songLinks = songList.map(function (song) {
	      count++;
	      return React.createElement(
	        'div',
	        { key: count, className: 'song', onClick: this.handleClick },
	        song
	      );
	    }.bind(this));
